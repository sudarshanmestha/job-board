...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["jobs.justpython.in"])
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="djangojobboard <noreply@jobs.justpython.in>"
)
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://production--justpython.netlify.app",
]
